...
class Service(ABC, Generic[PYDANTIC_MODEL]):
     ...
     @abstractmethod
     async def read(self, **extras) -> PYDANTIC_MODEL:
          raise NotImplementedError
     
     
     @abstractmethod
     async def create(self, **extras) -> None:
          raise NotImplementedError
     
     
     @abstractmethod
     async def update(self, where: dict[str, Any], **extras) -> None:
          raise NotImplementedError
...
class ParentService(Service, Generic[PYDANTIC_MODEL], Session):
     ...
     async def read(self, *values, **extras) -> PYDANTIC_MODEL | None | list[Any]:
     ...
     async def create(self, *args, **extras) -> None:
